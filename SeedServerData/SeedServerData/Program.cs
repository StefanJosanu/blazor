...
using SeedServerData.Data;
using SeedServerData.Data.Entities;

namespace SeedServerData
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            services.AddDbContext<AppDbContext>(options => options.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Database=ConsoleSeeding;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False"));
